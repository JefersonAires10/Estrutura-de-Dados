...
// Escreva uma função recursiva que recebe duas arvores binárias e retorna true se elas são idênticas e false caso contrário
...
// Escreva uma fução recursiva que crie uma cópia (um clone) de uma arvore binaria
